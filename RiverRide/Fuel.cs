...
namespace RiverRide
{
    class Fuel
    {
        ...
        public Fuel()
        {
            fuelIndicatorBounds = new Rectangle(Globals.screenSizeX/4 - Globals.fuelIndicatorBox.Width / 2, Globals.userInterfaceArea.Bottom- Globals.fuelIndicatorBox.Height * 3 / 2, Globals.fuelIndicatorBox.Width, Globals.fuelIndicatorBox.Height); ;
