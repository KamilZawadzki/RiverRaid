...
namespace RiverRide
{
    ...
    public class Game1 : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            Globals.mapArea = new Rectangle(0, 0, Globals.screenSizeX, Globals.screenSizeY *75/100);
            Globals.userInterfaceArea = new Rectangle(0, Globals.screenSizeY * 75/100, Globals.screenSizeX, Globals.screenSizeY - Globals.mapArea.Height);

            Globals.bulletsBtn = new Rectangle(0, Globals.userInterfaceArea.Y, Globals.screenSizeX / 3, Globals.userInterfaceArea.Height);

            Globals.inputUp = new Rectangle((Globals.screenSizeX * 3 / 4 - Globals.inputButtonsTexture.Width * 2)+ Globals.inputButtonsTexture.Width*4/3, (Globals.bulletsBtn.Center.Y - Globals.inputButtonsTexture.Height * 2), Globals.inputButtonsTexture.Width * 4 / 3, Globals.inputButtonsTexture.Height * 4 / 3);
            Globals.inputDown = new Rectangle((Globals.screenSizeX * 3 / 4 - Globals.inputButtonsTexture.Width * 2)+ Globals.inputButtonsTexture.Width*4/3, (Globals.bulletsBtn.Center.Y - Globals.inputButtonsTexture.Height * 2) + Globals.inputButtonsTexture.Height * 4 * 2 / 3, Globals.inputButtonsTexture.Width * 4 / 3, Globals.inputButtonsTexture.Height * 4 / 3);
            Globals.inputRight = new Rectangle((Globals.screenSizeX * 3 / 4 - Globals.inputButtonsTexture.Width * 2)+ Globals.inputButtonsTexture.Width*4*2/3, (Globals.bulletsBtn.Center.Y - Globals.inputButtonsTexture.Height * 2) + Globals.inputButtonsTexture.Height * 4 / 3, Globals.inputButtonsTexture.Width * 4 / 3, Globals.inputButtonsTexture.Height * 4 / 3);
            Globals.inputLeft = new Rectangle(Globals.screenSizeX * 3 / 4 - Globals.inputButtonsTexture.Width * 2, (Globals.bulletsBtn.Center.Y - Globals.inputButtonsTexture.Height * 2)+ Globals.inputButtonsTexture.Height*4/3, Globals.inputButtonsTexture.Width * 4 / 3, Globals.inputButtonsTexture.Height*4/3);
